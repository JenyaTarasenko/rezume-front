    ...
    return(
        ...
        <section id="technology" className='job-section'>
            <div className='job-container'>
                <Link to="git" smooth={true} duration={500}>
                    <div className='job-card'>
                        <div className='job-card-icon'>
                            <svg className="git-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
